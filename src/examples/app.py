...
class PaypalApp(appier.WebApp):
    ...
    def __init__(self, *args, **kwargs):
        appier.WebApp.__init__(self, name="paypal", *args, **kwargs)
    ...
    def new_payment(self):
        ...
        transaction = dict(
            amount=dict(total="%.2f" % amount, currency=currency),
    ...
    def cancel_payment(self):
        token = self.field("token")
        return dict(message="Canceled payment", operation="cancel", token=token)
